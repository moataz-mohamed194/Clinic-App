...
class AddUpdateUserBloc extends Bloc<AddUpdateUserEvent, AddUpdateUserState>{
  ...
  AddUpdateUserBloc({required this.addUser,
    required this.updateUser}) : super(UserInitial()){
  ...
  AddUpdateUserState _mapFailureOrPostsToStateForAdd(Either<Failures, Unit> either, String message) {
    return either.fold(
