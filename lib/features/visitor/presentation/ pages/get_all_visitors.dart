...
class GetAllVisitors extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: WidgetAppBar(
          context: context, title: S.of(context).Visitors, showHomeIcon: true),
      body: _buildBody(),
              ...
              if (state is LoadingVisitorsState) {
                ...
                return RefreshIndicator(
                    ...
                    child: visitorListWidget(
                        visitor: state.visitors, typeOfLogin: typeOfLogin));
  ...
  Widget _buildFloatingBtn(BuildContext context) {
    return FloatingActionButton(
      onPressed: () async {
        Navigator.push(
            context, MaterialPageRoute(builder: (_) => VisitorAddPage()));
      },
      child: Icon(
        Icons.add,
        color: Colors.white,
