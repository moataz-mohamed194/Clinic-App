...
class VisitorRepositoriesImpl implements VisitorRepository{
  ...
  VisitorRepositoriesImpl({required this.remoteDataSource,
  ...
  Future<Either<Failures, Unit>> addVisitor(Visitor visitor) async{
    final VisitorModel visitorModel = VisitorModel(id: visitor.id,
        addedByName: visitor.addedByName, name: visitor.name,
        reasonOfVisitor: visitor.reasonOfVisitor, time: visitor.time, approved: visitor.approved,
